...
const defaultPeopleClasses: PeopleClassDef[] = [
...
export function PeopleProvider({
    ...
    const value = useMemo(() => ({
        ...
        forceRefreshPerson
    }), [classes, classOrder, byClass, addPersonFromSearch, moveItemToClass, updatePersonCache, removePersonEntry, getPersonById, onPersist, reorderWithinClass, moveItemWithinClass, moveItemInClassOrder, renameItemClass, renameItemClassTagline, forceRefreshPerson]);
